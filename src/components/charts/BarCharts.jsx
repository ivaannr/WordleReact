...
export const StackedBarChart = ({ data }) => {
  return (
    <BarChart
      style={{ width: '95%', maxHeight: '30vh', aspectRatio: 1.618, backgroundColor: "transparent", borderColor: "transparent" }}
      responsive
      data={data}
      margin={{
        top: 60,
    ...
    >
      ...
      <YAxis width="auto" />
      <Tooltip />
      <Bar dataKey="pv" stackId="a" fill="#1e92ff" background />
      <Bar dataKey="uv" stackId="a" fill="#ff3131" background />
      <RechartsDevtools />
    </BarChart>
  );
};
